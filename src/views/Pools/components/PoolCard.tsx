...
const PoolCard: React.FC<HarvestProps> = ({ pool }) => {
  ...
  const { onSend } = useTransfer(sousId);
  // const { onSend1 } = useTransfer(sousId+1)
...
*/
  const poolImage = `${pool.tokenName}.svg`.toLocaleLowerCase();
